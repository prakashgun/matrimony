# Generated by Django 3.0.5 on 2020-05-20 18:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='currency_type_profile_set', to='matrimony.CurrencyType')),
                ...
                ('employed_in', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='employed_in_profile_set', to='matrimony.EmployedIn')),
                ...
                ('spoken_languages', models.ManyToManyField(blank=True, related_name='spoken_languages_profile_set', to='matrimony.Language')),
